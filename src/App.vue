...
//import InitialComp from "./components/InitialComp.vue";
...
body {
 ...
 @keyframes noise-1 {
	 ...
	 6.6666666667% {
		 clip-path: inset(64px 0 34px 0);
	}
	 10% {
		 clip-path: inset(43px 0 58px 0);
	}
	 13.3333333333% {
		 clip-path: inset(44px 0 23px 0);
	}
	 16.6666666667% {
	 ...
	 63.3333333333% {
		 clip-path: inset(50px 0 38px 0);
	}
	 66.6666666667% {
		 clip-path: inset(35px 0 37px 0);
	}
	 70% {
		 clip-path: inset(9px 0 66px 0);
	}
	 73.3333333333% {
 ...
 @keyframes noise-2 {
	 ...
	 3.3333333333% {
		 clip-path: inset(52px 0 40px 0);
	}
	 6.6666666667% {
		 clip-path: inset(1px 0 56px 0);
	}
	 10% {
	 ...
	 56.6666666667% {
		 clip-path: inset(27px 0 54px 0);
	}
	 60% {
		 clip-path: inset(36px 0 43px 0);
	}
	 63.3333333333% {
	 ...
	 70% {
		 clip-path: inset(20px 0 43px 0);
	}
	 73.3333333333% {
		 clip-path: inset(88px 0 10px 0);
	}
	 76.6666666667% {
		 clip-path: inset(19px 0 46px 0);
	}
	 80% {
		 clip-path: inset(6px 0 66px 0);
	}
	 83.3333333333% {
